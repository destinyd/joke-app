...
import static dd.android.joke.core.Constants.Extra.NAME;
 ...
 */
public class ActivityReg extends
     ...
     */
    private String email, password, password_confirmation, name, phone;
    ...
    private void updateUIWithValidation() {
        boolean populated = populated(et_name) && populated(et_password) &&
                populated(et_password_confirmation) && (populated(et_email) || populated(et_phone)) &&
